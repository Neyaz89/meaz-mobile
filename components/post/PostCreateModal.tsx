...
export type PrivacyOption = 'public' | 'friends' | 'custom';
      ...
      <View style={styles.overlay}>
        <View style={styles.modal}>
          ...
          <View style={styles.optionsRow}>
            ...
            {/* Add more option buttons here if needed */}
          </View>
          ...
          >
            {uploading ? <ActivityIndicator color="#fff" /> : <Text style={styles.submitBtnText}>Post</Text>}
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  captionInput: { backgroundColor: '#f2f2f2', borderRadius: 8, padding: 10, fontSize: 15, width: '100%', minHeight: 60, marginBottom: 10 },
